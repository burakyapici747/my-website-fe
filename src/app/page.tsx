...
function Page() {
    return (
        <>
            ...
            <div className="developer-info site-main-container flex flex-row justify-between site-margin-bottom">
                        ...
                        <li>
                            <Link href="https://www.linkedin.com/in/burakyapici/">
                                <svg xmlns="http://www.w3.org/2000/svg" width="27px" height="27px" viewBox="0 0 16 16">
                                    <path fill="#0077B5" d="M12.225 12.225h-1.778V9.44c0-.664-.012-1.519-.925-1.519-.926 0-1.068.724-1.068 1.47v2.834H6.676V6.498h1.707v.783h.024c.348-.594.996-.95 1.684-.925 1.802 0 2.135 1.185 2.135 2.728l-.001 3.14zM4.67 5.715a1.037 1.037 0 01-1.032-1.031c0-.566.466-1.032 1.032-1.032.566 0 1.031.466 1.032 1.032 0 .566-.466 1.032-1.032 1.032zm.889 6.51h-1.78V6.498h1.78v5.727zM13.11 2H2.885A.88.88 0 002 2.866v10.268a.88.88 0 00.885.866h10.226a.882.882 0 00.889-.866V2.865a.88.88 0 00-.889-.864z"/>
                                </svg>
                            </Link>
                        </li>
                        <li>
                            <Link href="https://leetcode.com/burakyapici/">
                                <svg width="27px" height="27px" viewBox="0 0 95 111" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-auto max-w-none">
                                    ...
                                    <path d="M41.1067 72.0014C37.5858 72.0014 34.7314 69.1421 34.7314 65.615C34.7314 62.0879 37.5858 59.2286 41.1067 59.2286H88.1245C91.6454 59.2286 94.4997 62.0879 94.4997 65.615C94.4997 69.1421 91.6454 72.0014 88.1245 72.0014H41.1067Z" fill="gray"></path>
                                    <path d="M49.9118 2.02335C52.3173 -0.55232 56.3517 -0.686894 58.9228 1.72277C61.494 4.13244 61.6284 8.17385 59.2229 10.7495L16.4276 56.5729C11.7768 61.552 12.2861 69.5738 17.6453 74.8292L37.4088 94.2091C39.9249 96.6764 39.968 100.72 37.505 103.24C35.042 105.761 31.0056 105.804 28.4895 103.337L8.72593 83.9567C-1.42529 74.0021 -2.43665 58.0741 7.1169 47.8463L49.9118 2.02335Z" fill="#070706"></path>
                                </svg>
                            </Link>
                        </li>
                        <li>
            ...
            <div className="bio-info site-main-container flex flex-col gap-1 site-margin-bottom">
            ...
            <div className="hobbies-info site-main-container site-margin-bottom">
                <h3 className={`text-xl underline decoration-4 underline-offset-4 decoration-[#525252] mb-2 ${mPlusRounded.className}`}>I ♥</h3>
                <p className={`font-extralight text-md antialiased ${openSans.className}`}>
                     🏊‍ swimming <br/>🏕️ camping <br/>🎿 skiing <br/>🕹️ computer games
                </p>
            </div>
        </>
    );
